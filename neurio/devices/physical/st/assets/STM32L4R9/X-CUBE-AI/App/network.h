...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "miniconv"
...
#define AI_NETWORK_OUT_1_HEIGHT      (5)
#define AI_NETWORK_OUT_1_WIDTH       (5)
#define AI_NETWORK_OUT_1_CHANNEL     (16)
#define AI_NETWORK_OUT_1_SIZE        (5 * 5 * 16)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (1600)
